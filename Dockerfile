...
RUN apt-get update; apt-get install -y python3-pip; \
    ...
    pip install pandas; pip install pillow; pip install Flask-Bcrypt==1.0.1; pip install Flask==2.1.2; pip install flask-restx; pip install werkzeug==2.1.2; pip install flask_cors
